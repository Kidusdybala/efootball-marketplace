...
const statusEmoji = (s) => ({
  available: '<tg-emoji emoji-id="6100340203119971469">🔥</tg-emoji> AVAILABLE', reserved: '<tg-emoji emoji-id="5368324170671202289">🟡</tg-emoji> RESERVED', sold: '<tg-emoji emoji-id="5368324170671202288">🔴</tg-emoji> SOLD',
  pending_review: '<tg-emoji emoji-id="5368324170671202289">⏳</tg-emoji> PENDING REVIEW', rejected: '<tg-emoji emoji-id="6100670215522094562">❌</tg-emoji> REJECTED', deleted: '<tg-emoji emoji-id="5368324170671202289">🗑️</tg-emoji> DELETED',
  approved: '<tg-emoji emoji-id="5472100166909577091">✅</tg-emoji> APPROVED', waiting_escrow: '<tg-emoji emoji-id="5368324170671202290">🤝</tg-emoji> DEAL AGREED',
